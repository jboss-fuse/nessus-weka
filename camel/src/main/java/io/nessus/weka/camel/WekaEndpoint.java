 ...
 */
@UriEndpoint(firstVersion = "3.0.2", scheme = "weka", title = "Weka",
        syntax = "weka:cmd", producerOnly = true, label = "file", generateConfigurer = false)
public class WekaEndpoint extends DefaultEndpoint {

    static final Logger LOG = LoggerFactory.getLogger(WekaEndpoint.class);
    
    @UriParam
    private final WekaConfiguration config;
    ...
    WekaConfiguration getConfiguration() {
        return config;
    }
